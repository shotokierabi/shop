    ...
    <div class="container-fluid">
        <div class="container1 admin">
            <div class="personal_account row">
                ...
                <div class="col2_2">
                    <form class="form" action="edit_prod.php" method="post">
                        ...
                        <div class="col">
                            ...
                            <textarea maxlength="1500" name="structure" type="text" class="form-control" rows="5"
                                cols="155" id="exampleInputDop"><?= $structure ?></textarea>
                        </div>
                        <div class="col">
                            <div class="col3">
                                <span class="text-1">Описание:</span>
                            </div>
                            <textarea maxlength="1500" name="descriptions" type="text" class="form-control" rows="5"
                                cols="155" id="exampleInputDop"><?= $descriptions ?></textarea>
                        </div>
                        <div class="col but">
                            <button class="button btn" name="edit_prod" type="submit">Сохранить
                                изменения</button>
                        </div>
                    </form>
                </div>
